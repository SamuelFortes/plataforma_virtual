...
class UBS(Base):
    ...
    # Multi-tenant support (per-organization). For now we use a simple integer tenant id.
...
class Indicator(Base):
    ...
    tipo_dado = Column(String(40), nullable=False)  # e.g. NUMERO_ABSOLUTO, TAXA_PERCENTUAL
